      ...
      <main className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          ...
          <form
            ...
            className="glass-card-solid p-8 slide-up"
          >
            {loginError && (
          ...
          <div className="glass-card-solid p-6 slide-up">
            ...
            <div className="space-y-4">
              <div>
                ...
                >
                  <option value={1} className="bg-deep-purple">
                    Round 1: Dishoom
                  </option>
                  <option value={2} className="bg-deep-purple">
                    Round 2: Eve Bar
                  </option>
                  <option value={3} className="bg-deep-purple">
                    Round 3: Lilibet
                  </option>
                </select>
              </div>
